...
class TimeCheckBackgroundWork(context: Context, workerParameters: WorkerParameters) : Worker(context, workerParameters) {
    ...
    override fun doWork(): Result {
        NotificationProcessor.postNotification(NotificationData(title = "Out of sync", content = "This is an automatic notification. Your device is well behind the real clock - 4 years, 34 minutes and 53 milliseconds"))
